...
| `deprecatedAuthProfileIds`           | No       | `string[]`                   | Legacy auth profile ids that generic auth must ignore before provider runtime loads. Doctor remains responsible for migrating or removing the retired records.                                                                                                                                                                                                                                   |
